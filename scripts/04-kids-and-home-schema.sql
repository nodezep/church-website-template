...
create table if not exists public.contact_page (
  ...
  map_link text default 'https://www.google.com/maps/search/?api=1&query=Doxor\+Christian\+Center',
  phone_general text default '+44 20 1234 5678',
  phone_prayer text default '+44 20 9876 5432',
  email_general text default 'info@dcc.org',
  email_prayer text default 'prayer@dcc.org',
