...
export const metadata = {
  title: "Contact Us - JSC Church",
  description:
    "Get in touch with JSC Church. Find our location, contact details, service times, and frequently asked questions.",
}
...
export default async function ContactPage() {
  ...
  const mapLink = dynamic?.map_link || "https://www.google.com/maps/search/?api=1&query=JSC+Church"
